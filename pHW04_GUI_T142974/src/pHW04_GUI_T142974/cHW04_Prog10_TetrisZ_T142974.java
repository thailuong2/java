 ...
 *
 */
public class cHW04_Prog10_TetrisZ_T142974 extends JFrame {
	cTetrisZ_Panel_T142974 a = new cTetrisZ_Panel_T142974();
	JButton btn1 = new JButton("Left"), btn2 = new JButton("Right"),
			btn3 = new JButton("Up"), btn4 = new JButton("Down");
	public static void main(String[] args) {
		cHW04_Prog10_TetrisZ_T142974 Main = new cHW04_Prog10_TetrisZ_T142974();
		Main.setDefaultCloseOperation(EXIT_ON_CLOSE);
		Main.setVisible(true);

	}
	public cHW04_Prog10_TetrisZ_T142974(){
		setTitle("Tetris moving (Z) - T142974 ");
		setSize(600,800);
		setLayout(null);
		add(btn1);
		add(btn2);
